...
final dailySalesProvider = FutureProvider.autoDispose<List<DailySalesPoint>>((
  ref,
) async {
...
final categorySalesProvider = FutureProvider.autoDispose<List<CategoryShare>>((
  ref,
) async {
  final repo = ref.watch(analyticsRepositoryProvider);
...
final topProductsProvider =
    FutureProvider.autoDispose<List<ProductPerformance>>((ref) async {
      final repo = ref.watch(analyticsRepositoryProvider);
