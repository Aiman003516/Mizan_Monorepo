...
| 26 | `20260827290000_reviewed_extension_registry.sql` | Versioned declarative extension descriptors, bounded capabilities, owner review, RLS, and audit hooks | Added in the current upgrade; not applied |
